        ...
        <div className="container max-w-6xl mx-auto">
          <div className="flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  <img
                    src="/src/assets/media/JOBQUEST.jpg"
                    alt="logo"
                ...
                Stay connected with us for updates, news, and exciting career opportunities. Join our journey!
                </p>
                <p className="flex items-center text-sm font-medium text-dark dark:text">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibold text-dark dark:text">
                  Follow Us On
                </h4>

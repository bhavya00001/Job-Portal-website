            ...
            <Wrapper ref={heroRef}>
                <div className="hero-content">
                    <div className="text-content">
                        ...
                        <p>
                        Unlock a world of endless opportunities where your skills meet the perfect career match. Say goodbye to endless scrolling and hello to personalized job recommendations tailored just for you.
                        </p>
